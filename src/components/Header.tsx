...
const Header   = () => {
  ...
  return (
    <header className="py-6 px-4 md:px-8 sticky top-0 z-50 bg-[#00040F] bg-opacity-80 backdrop-blur-md shadow-md" role="banner">
      ...
      {isMobileMenuOpen && (
        <nav className="md:hidden absolute top-full left-0 right-0 bg-[#00040F] bg-opacity-95 backdrop-blur-md shadow-lg py-4 z-40" aria-label="Mobile navigation">
